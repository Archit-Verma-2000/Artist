...
<body id="page-top">
    ...
    <script src="Public/assets/vendor/jquery-easing/jquery.easing.js"></script>

    <!-- Custom scripts for all pages-->
    <script src="Public/assets/Admin/js/sb-admin-2.min.js"></script>

    <!-- Page level plugins -->
    <script src="Public/assets/vendor/chart.js/Chart.js"></script>
    ...
    <script src="Public/assets/Admin/js/demo/chart-bar-demo.js"></script>
